            ...
            <div className="flex flex-col lg:flex-row p-20 lg:space-x-8 space-y-6 lg:space-y-0 bg-secondary-300 rounded-xl">
                ...
                <div className="flex flex-col space-y-6 lg:w-1/2">
                    ...
                    <ul className="section__check-list space-y-4">
                        <li className="section__item__title"><i className="text-secondary-600 text-4xl" />&nbsp;&nbsp;Automation for clinic operations</li>
                        <li className="section__item__title"><i className="text-secondary-600 text-4xl" />&nbsp;&nbsp;Integrated systems</li>
                        <li className="section__item__title"><i className="text-secondary-600 text-4xl" />&nbsp;&nbsp;Inventory management</li>
                        <li className="section__item__title"><i className="text-secondary-600 text-4xl" />&nbsp;&nbsp;Data security</li>
                    </ul>
                </div>
                ...
                <div className="space-y-10 md:space-y-14 lg:space-y-0 lg:w-1/2">
                    <div className="p-10 bg-white rounded-xl shadow-custom-down">
                        <form action="" method="post" className="space-y-6">
                            ...
                            <button type="submit" className="button--primary w-full">Book demo</button>
                        </form>
                    </div>
                </div>
            </div>
